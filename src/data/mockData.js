// Catalogue de 100 biens pour Global Immobilier Midas Volta �nergie C�te D'Ivoire
...
export const MOCK_USERS_LIST = [
  ...
  { id: 'u3', name: 'Aubry Admin', email: 'admin@globalimmobiliermidasvoltanergiectedivoire.cm', role: 'admin', status: 'Actif', joinDate: '01/01/2026' }
];
